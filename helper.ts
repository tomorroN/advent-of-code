...
const session = '53616c7465645f5f5e40087102b96ea8cd8fbfa1b0684f8ace69cb16bba72d1b8cb70658dc513847903d0a558e2a20d3';
...
export function getTestFunction(call: (input: string[]) => number): (data: string[], expected: unknown) => boolean {
